...
sysShutterManual = lep_sys_shutter_mode(
    0, 0, 1, 0, 0, 180000, explicitCmdToOpenVal, desiredFfcTempDeltaVal, imminentDelayVal)
sysShutterAuto = lep_sys_shutter_mode(
    1, 0, 1, 0, 0, 180000, explicitCmdToOpenVal, desiredFfcTempDeltaVal, imminentDelayVal)
sysShutterExternal = lep_sys_shutter_mode(
    2, 0, 1, 0, 0, 180000, explicitCmdToOpenVal, desiredFfcTempDeltaVal, imminentDelayVal)
...
def set_manual_ffc(devh):
    ...
    set_extension_unit(devh, SYS_UNIT_ID, controlID,
                       byref(sysShutterManual), sizeData)
...
def set_external_ffc(devh):
    ...
    print('controlID: ' + str(controlID))
    set_extension_unit(devh, SYS_UNIT_ID, controlID,
                       byref(sysShutterExternal), sizeData)
...
def perform_manual_ffc(devh):
    ...
    print('controlID: ' + str(controlID))
    # set_extension_unit(devh, unit, control, data, size)
    set_extension_unit(devh, SYS_UNIT_ID, controlID, shutter_mode, sizeData)
